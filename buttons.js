...
var debugJSON = {
    ...
    ToggleSupports: function () {
        TRACK.toggleSupports()
    }
...
var testingButtonJson = {
    ...
    LeftBig: function () {
        TRACK.insertPiece(new Piece(TRACK_TYPES.TURN_LEFT_BIG));
    },
    RightBig: function () {
        TRACK.insertPiece(new Piece(TRACK_TYPES.TURN_RIGHT_BIG));
    },
    Delete: function () {
        TRACK.deletePiece();
    },
